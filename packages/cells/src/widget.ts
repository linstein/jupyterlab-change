 ...
 */
const DEFAULT_MARKDOWN_TEXT = '双击即可修改文本信息';
...
export class Cell extends Widget {
  ...
  constructor(options: Cell.IOptions) {
    ...
    Object.assign(this.node.style, {"margin-bottom":"10px"});
    // Header
...
export class CodeCell extends Cell {
  ...
  constructor(options: CodeCell.IOptions) {
    ...
    Object.assign(this.node.style, {"margin-bottom":"10px","border":'1px solid'});
