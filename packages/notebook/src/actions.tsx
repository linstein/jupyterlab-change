...
export namespace NotebookActions {
  ...
  export function runAndAdvance(
    ...
    if (notebook.activeCellIndex === notebook.widgets.length - 1) {
      ...
      const sendx={'cellid':cellid,'index':notebook.activeCellIndex + 1,'func':'sync','spec':'createcell',"celltype":"code"};
      comm!.send(sendx);
      notebook.activeCellIndex++;
      notebook.mode = 'edit';
    } else {
...
export namespace Private {
  ...
  export function runSelected(
    ...
    let list_readOnly=false;
    selected.map(child => {
      if(child.readOnly==true){
        list_readOnly=true;
      }else if(child.model.type=="code" && child.model.value.text.trim()){
        codecell_length++;
      }
