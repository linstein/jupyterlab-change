...
export class exec_handler {
  _onExecMsg: (msg: KernelMessage.Message) => void | PromiseLike<void>;

  set onExecMsg(cb: (msg: KernelMessage.Message) => void | PromiseLike<void>){
    console.log("set onexecmsg33333333333333333333333333333333");
    this._onExecMsg = cb;
  }
  get onExecMsg(): (msg: KernelMessage.Message) => void | PromiseLike<void>{
    return this._onExecMsg;
  }
}