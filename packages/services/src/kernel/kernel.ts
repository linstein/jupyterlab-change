...
export interface IKernelConnection extends IObservableDisposable {
  ...
  //
  // onExecMsg(cb: (msg: KernelMessage.Message) => void | PromiseLike<void>):void;
  //
  // getonExecMsg(): (msg: KernelMessage.Message) => void | PromiseLike<void>;
  /**
